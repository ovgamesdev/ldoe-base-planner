...
$origWidth  = 1800   # Исходная ширина картинки
$origHeight = 2200   # Исходная высота картинки

$diff = 1

$cropLeft   = 156 + $diff    # Отрезать слева
$cropRight  = 155 + $diff    # Отрезать справа
$cropTop    = 170 + $diff    # Отрезать сверху
$cropBottom = 169 + $diff    # Отрезать снизу
# =======================================================
